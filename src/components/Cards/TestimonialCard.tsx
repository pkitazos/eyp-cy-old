...
import { QuoteLeftIcon, QuoteRightIcon } from "..";
...
const MobileLayout = (props: props) => {
  ...
  return (
    <div
      className={`${className}  flex h-max w-full flex-row rounded-2xl bg-white p-8 shadow-md`}
    >
...
const DesktopLayout = (props: props) => {
  ...
  return (
    <div
      className={`${className}  flex h-max w-full flex-row rounded-2xl bg-white p-16 shadow-md`}
    >
