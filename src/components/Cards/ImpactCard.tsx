...
const ImpactCard: FC<props> = ({
  ...
  return (
    <div className={`flex ${rowDirection} items-center gap-10`}>
      <div
        className={`${hideDirection} delay-card hidden h-full sm:flex lg:w-1/2 xl:w-2/5`}
      >
        <MaskedImage src={imageURL} />
      </div>
      <div
        className={`${hideDirection} flex flex-col justify-center gap-y-4 lg:w-1/2 xl:w-3/5`}
      >
