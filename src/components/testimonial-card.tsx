...
export function TestimonialCard({
  ...
  return (
    <section className="--lime isolate overflow-hidden bg-white rounded-lg px-6 lg:px-8">
      <div className="relative mx-auto max-w-2xl py-18 sm:py-20 lg:max-w-4xl">
        ...
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            <svg
              ...
              fill="currentColor"
              aria-hidden="true"
              className="absolute -top-12 left-0 -z-10 h-32 text-gray-900/10"
            >
              <path
            ...
            <blockquote className="text-lg sm:text-xl font-semibold xl:leading-8 text-gray-900">
              <p>{children}</p>
            </blockquote>
          </div>
          <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
            <Image
              ...
              src={imageURL}
              alt="..."
              className="my-auto aspect-square rounded-full object-cover object-center"
            />
          </div>
