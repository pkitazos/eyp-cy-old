...
export default function PatronsAndPartners() {
  return (
    <RootLayout>
      ...
      <WaveDivider waveLayers={paths.patronsTop} />
      <section className="page-padding bg-primary-800 max-h-max min-h-[60vh] pb-24 pt-16">
      ...
      <WaveDivider waveLayers={paths.patronsBottom} />
      <section className="page-margin max-h-max min-h-[60vh]">
        <div className="flex justify-center sm:justify-start">
          <Title text="Our Partners" order="h2" underlineRotation="rotate-12" />
        </div>
        <div className="md-lg:justify-start flex flex-col items-center justify-center gap-10 sm:flex-row">
          <PartnerCard
            name="Ant1"
