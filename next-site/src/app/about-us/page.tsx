...
export default function AboutUs() {
  return (
    <RootLayout>
      ...
      <WaveDivider waveLayers={paths.aboutTop} />
      <section className="page-padding bg-primary-600 max-h-max min-h-[60vh] pb-20 pt-8">
        <div className="flex justify-center">
          <Title
            text="What We Do"
            order="h2"
      ...
      <WaveDivider waveLayers={paths.aboutBottom} />
      <section className="page-margin mt-8 max-h-max min-h-[60vh] px-4 pb-16">
        <div className="hide-left">
          ...
          <p className="text-justify text-lg leading-relaxed md:text-xl">
            ...
            and Europe. With 15+ events annually, and 500+ participants at our
            activities each year, our organisation is growing and reaching more
            and more young people! And with EYP Cyprus being part of the wider
            EYP Network present in 40+ countries in Europe, our members and
            alumni have the opportunity to join over 30,000 young people who
            take part in more than 500 EYP events organised across Europe every
            year.
          </p>
        </div>
      </section>
