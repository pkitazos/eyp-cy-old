...
export default function Events() {
  return (
    <RootLayout>
      ...
      <WaveDivider waveLayers={paths.eventsTop} />
      <section className="page-padding bg-primary-700 flex max-h-max min-h-[40vh] flex-col justify-around pt-10">
      ...
      <WaveDivider waveLayers={paths.eventsBottom} />
