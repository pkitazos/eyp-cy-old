      ...
      <section className="page-margin mb-32 grid grid-cols-1 gap-16 px-5 md:grid-cols-2">
        <div className="hide-left flex flex-col items-center gap-4">
          ...
          <p className="mb-4 text-justify text-xl">
            ...
            attend EYP Cyprus' annual National Session in the Summer. If you are
            interested in attending either of these events, you can contact our
            HR members@eypcyprus.com to declare your interest or ask for further
            details.
          </p>
